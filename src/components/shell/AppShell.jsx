...
import { getUnlockedStyles } from "../../data/characterStyles";
...
export default function AppShell({ profile, syncStatus, activeSection, tab, onChangeTab, children, focusMode = false }) {
  ...
  const stylesOwned=getUnlockedStyles(profile?.xp||0).length;
  ...
  return <div className="v47-root">
    ...
    <footer className="v47-footer"><div><b>20</b><span><strong>Stil Koleksiyonu</strong><i><em style={{width:`${Math.max(5,Math.round((stylesOwned/20)*100))}%`}}/></i></span><small>{stylesOwned} / 20</small></div><p>✦ <strong>Bilgi güçtür.</strong> XP kazan, yeni stiller aç!</p><div className="v47-flags"><span>🇪🇺</span><span>🇹🇷</span><small>Birlikte daha güçlü bir gelecek için.</small><b>v5.0</b></div></footer>
  </div>;
}
