export const ROOM_TYPES = [
  { id: "bedroom", title: "Pembe Yatak Odası 🛏️", emoji: "🛏️", unlockWorld: "w1" },
  { id: "playroom", title: "Sihirli Oyun Odası 🧸", emoji: "🧸", unlockWorld: "w2" },
  { id: "studyroom", title: "Çalışma Odası 📚", emoji: "📚", unlockWorld: "w4" },
  { id: "livingroom", title: "Prenses Oturma Odası 🛋️", emoji: "🛋️", unlockWorld: "w6" },
  { id: "garden", title: "Çiçekli Bahçe 🌸", emoji: "🌳", unlockWorld: "w8" },
  { id: "library", title: "Sihirli Kütüphane 📖", emoji: "📖", unlockWorld: "w10" },
];

export const COMPLETION_ITEM_THRESHOLD = 6;

export function createEmptyRoomState() {
  return { wallpaper: null, items: [] };
}
